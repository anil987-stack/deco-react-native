...
<View style={{ marginTop: "6%",marginBottom:"4%" }}>
          ...
          <View style={{...Style.keyvalue,borderWidth:0,width:"100%",marginLeft:"0%",flex:1,flexDirection:"row",}}>
            <Text style={{...Style.value1,color:"grey",justifyContent:"center",textAlign:"center",marginLeft:"-22%",fontSize:12,fontWeight:"bold"}}>{"Contractor | A | AIDP"}</Text>
