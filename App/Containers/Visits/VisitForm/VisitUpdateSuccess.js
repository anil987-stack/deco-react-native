...
class VisitUpdateSuccess extends Component {
  fetchCall() {
    const {
      token,
    ...
    return (
      <View>
        <View style={{ alignItems: "center", top: hp("18%") }}>
          ...
          >
            Visit Info Updated Successfully!
          </Text>
        </View>
        <TouchableOpacity
          style={{
          ...
          onPress={() => {
            NavigationService.navigate("StartVisitForm"), this.fetchCall(),this.props.disabledForm();
          }}
        >
          <Text
            style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(VisitUpdateSuccess);
