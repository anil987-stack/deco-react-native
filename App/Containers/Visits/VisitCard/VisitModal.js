...
class MenuModal extends React.Component {
  ...
  render() {
    const { form, changeForm ,heading3ContainerStyle} = this.props;
console.log(this.props.heading3ContainerStyle,"hhhh");
    return (
      <View style={{ ...Style.box1 }}>
        <View style={{ ...Style.buttonBox }}>
          ...
          <Text style={{ ...Style.text, marginTop:wp("2%") }}>
            {"OBJECTIVE"}
          </Text>
          <View style={{ height: "8%", marginTop: wp("3") }}>
            <SearchableDropdown
              //   dataSource={options1}
...
//               {"Select the appropriate reason from dropdown"}
//             </Text>

{
  /* <View
            style={{height: '20%', marginTop: wp('3')}}>
              <SearchableDropdown
                //   dataSource={options1}
                //   placeHolderText={"Select Project Type"}
                // dropstyle={{
