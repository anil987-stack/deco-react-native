...
import MappedModal from "./MappedModal";
...
class Modal extends React.Component {
  ...
  render() {
    ...
    return (
      // <View>
      <View style={{ display: "flex", flex: 1, marginTop: wp("-8%"), }}>
        ...
        <View>
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                NavigationService.navigate("RetailerForm");
              }}
            ...
            <TouchableOpacity
              onPress={() => {
                this.props.openModal({
                  ...
                  heading3: "MAPPED INFLUENCER MODAL",
                  bodyFlexHeight3: 0.8,
                });
              }}
              style={{ marginTop: hp("1.5%"), paddingBottom: 2 }}
          ...
          <View style={{ flexDirection: "row", marginTop: hp("-1.25%") }}>
            ...
            <TouchableOpacity
              onPress={() => {
                this.props.closeModal();
                NavigationService.navigate("VisitPerformance");
              }}
