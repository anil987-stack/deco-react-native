...
class PartialCard extends Component {
  constructor() {
    super();
    this.state = {
      data: [
  ...
  filterResults(list) {
    ...
    result = result.filter((obj) => obj.Order_Status__c == "Partially Delivered");
...
export default connect(mapStateToProps, mapDispatchToProps)(PartialCard);
