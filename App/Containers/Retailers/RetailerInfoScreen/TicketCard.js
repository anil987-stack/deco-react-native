...
const TicketCard = ({ onPress, id, data, areas, competitors, showdata }) => (
  <TouchableOpacity
    style={{
      marginVertical: 8,
      width: wp("88%"),
  ...
  >
    <View style={{ flexDirection: "row" }}>
      ...
      >
        ...
        >
          {data.Complaint_Open_Date__c
            ? HelperService.getCurrentDate(data.Complaint_Open_Date__c.substring(0,10))
            : "11"}
        </Text>
        <Text
          style={{
        ...
        >
          {data.Complaint_Open_Date__c
            ? HelperService.getMonthMappingName(
                HelperService.getCurrentMonth(data.Complaint_Open_Date__c.substring(0,10))
              )
            : "Jan"}
        </Text>
        <Text
