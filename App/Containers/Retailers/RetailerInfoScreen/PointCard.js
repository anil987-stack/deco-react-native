...
const PointCard = ({ onPress, id, data, areas, competitors, showdata }) => (
  <TouchableOpacity
    style={{
    // marginVertical: 8,
      width: wp("88%"),
  ...
  >
    <View style={{ flexDirection: "row" }}>
      ...
      >
        ...
        >
          {data.Validated_On__c
            ? HelperService.getCurrentDate(
                data.Validated_On__c.substring(0, 10)
              )
            : "11"}
        </Text>
        <Text
      ...
      >
        ...
        <View style={{ flexDirection: "row", marginBottom: wp(1.5),marginTop: wp(1.5) }}>
          <Text
            style={{
            // marginVertical: 2,
              fontWeight: "bold",
