...
export default class MechanicInfoKyc extends Component {
  render() {
    let item = this.props;
    return (
      <ScrollView>
        ...
        >
          ...
          <View style={{ marginTop: hp("1.5%") }}>
            ...
            <View style={{ width: wp("90"), marginLeft: wp("2%") }}>
              <InputNumber
                ...
                value={
                  item.item && item.item.length
                    ? item.item[0].Year_of_Establishment__c
                    : ""
                }
                editable={false}
                // value={form.Firm_Name__c}
          ...
          <View style={{ marginTop: hp("1.5%"), width: wp("90%") }}>
            ...
            <SearchableDropdown
              dataSource={options1}
              selectedValue={item.item && item.item.length ? item.item[0].Type__c : ""}
              disabled={true}
