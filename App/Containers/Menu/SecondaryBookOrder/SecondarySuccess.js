...
class SecondarySuccess extends Component {
  fetchCall() {
    ...
    return (
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            NavigationService.navigate("SecondaryOrder"), this.fetchCall();
          }}
        >
          <Text
            style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(SecondarySuccess);
