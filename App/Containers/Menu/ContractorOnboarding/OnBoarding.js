...
import MyBoarding from "./Onboardingtab/MyBoarding";
// import TeamBoarding from "App/Containers/Menu/ContractorOnBoarding/Onboardingtab/TeamBoarding";
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <Tab
            ...
            // activeTabStyle={{  color: Colors.white,
            //   fontWeight: "normal", }}
          >
            <MyBoarding id={"Draft"}/>
          </Tab>
        ...
        {/* <TouchableOpacity
          style={Styles.plusIcon}
          onPress={() => NavigationService.navigate("InfluencerKYCForm", { show: false })}
        >
          <GenericIcon
            name={"add"}
            style={{
