...
import InvoiceOrderCard from "App/Containers/Menu/Invoice/InvoiceOrderCard";
...
class ApprovedCard extends Component {
  ...
  filterResults(list) {
    ...
    let result = "";
    result = list.filter((obj) => obj.Order_Status__c == "Open");
...
export default connect(mapStateToProps, mapDispatchToProps)(InvoiceDetailsCard);
