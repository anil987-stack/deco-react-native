...
import RetailerQues from "./RetailerQues";
  ...
  onCheck() {
    ...
    if (!form.Name) {
      HelperService.showToast({
        message: "Firm name of Retailer Field is empty",
      });
    } else if (!form.Workshop_name__c) {
      HelperService.showToast({
        message: "Contact Person Name Field is empty",
      });
    } else if (!form.Phone) {
      HelperService.showToast({
