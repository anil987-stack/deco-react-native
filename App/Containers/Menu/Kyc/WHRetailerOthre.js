...
class WHRetailerOther extends Component {
  render() {
        ...
        >
              ...
              >
                <View>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.Workshop_name__c ? String(form.Workshop_name__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Workshop_No_1_Mobile_No__c
                        ? String(form.Workshop_No_1_Mobile_No__c)
                        : ""
                    }
                    maxLength={10}
                    onChangeText={(value) =>
                      changeForm({
                        edited_field: "Workshop_No_1_Mobile_No__c",
                        edited_value: value,
                      })
                    }
                  />
                  ...
                  <TextInput
                    ...
                    value={
                      form.Workshop_Owner_Name__c
                        ? String(form.Workshop_Owner_Name__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Retailer_No_1_Proprietor_Name__c
                        ? String(form.Retailer_No_1_Proprietor_Name__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                        edited_field: "Retailer_No_1_Proprietor_Name__c",
                        edited_value: value,
                      })
                    }
                  />
                  ...
                  <TextInput
                    ...
                    value={
                      form.Retailer_No_2_Proprietor_Name__c
                        ? String(form.Retailer_No_2_Proprietor_Name__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                        edited_field: "Retailer_No_2_Proprietor_Name__c",
                        edited_value: value,
                      })
                    }
                  />
                  ...
                  <TextInput
                    ...
                    value={
                      form.Retailer_No_3_Proprietor_Name__c
                        ? String(form.Retailer_No_3_Proprietor_Name__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                        edited_field: "Retailer_No_3_Proprietor_Name__c",
                        edited_value: value,
                      })
                    }
                  />
          ...
          <View style={{ marginTop: hp("1.5%") }}>
            ...
            <View style={{ width: wp("90"), marginLeft: wp("2%") }}>
              <InputNumber
                ...
                value={form.Apex_Monthly_Business_done_by_retailer__c}
                onChange={(value) =>
                  changeForm({
                    edited_field: "Apex_Monthly_Business_done_by_retailer__c",
                    edited_value: value,
                  })
                }
                // error={
              ...
              >
                ...
                <View style={{ justifyContent: "center" }}>
                  <TextInput
                    ...
                    placeholder="Value In Thousands"
                    placeholderTextColor="black"
                    value={form.LTVS_Value__c ? String(form.LTVS_Value__c) : ""}
                    onChangeText={(value) =>
                      changeForm({
              ...
              >
                ...
                <View style={{ justifyContent: "center" }}>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.Lispart_Value__c ? String(form.Lispart_Value__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
              ...
              >
                ...
                <View style={{ justifyContent: "center" }}>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.PRICOL_Value__c ? String(form.PRICOL_Value__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.TVS_Automotive_Value__c
                        ? String(form.TVS_Automotive_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.LUCAS_Batteries_Value__c
                        ? String(form.LUCAS_Batteries_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Brand_No_1_Value__c
                        ? String(form.Brand_No_1_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Brand_No_2_Value__c
                        ? String(form.Brand_No_2_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Brand_No_3_Value__c
                        ? String(form.Brand_No_3_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Brand_No_4_Value__c
                        ? String(form.Brand_No_4_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Brand_No_5_Value__c
                        ? String(form.Brand_No_5_Value__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
              ...
              >
                <View>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.Product_No_1__c ? String(form.Product_No_1__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_1_Part_No__c
                        ? String(form.Product_No_1_Part_No__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_1_Issue_faced_Description__c
                        ? String(form.Product_No_1_Issue_faced_Description__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
              ...
              >
                <View>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.Product_No_2__c ? String(form.Product_No_2__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_2_Part_No__c
                        ? String(form.Product_No_2_Part_No__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_2_Issue_faced_Description__c
                        ? String(form.Product_No_2_Issue_faced_Description__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
              ...
              >
                <View>
                  <TextInput
                    ...
                    placeholderTextColor="black"
                    value={
                      form.Product_No_3__c ? String(form.Product_No_3__c) : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_3_Part_No__c
                        ? String(form.Product_No_3_Part_No__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
                  ...
                  <TextInput
                    ...
                    value={
                      form.Product_No_3_Issue_faced_Description__c
                        ? String(form.Product_No_3_Issue_faced_Description__c)
                        : ""
                    }
                    onChangeText={(value) =>
                      changeForm({
          ...
          <View style={{ marginTop: hp("1.5%"), width: wp("90%") }}>
            ...
            <SearchableDropdown
              ...
              placeHolderText={"Select option"}
              selectedValue={form.Are_you_interested_for_Lucas_Service_Val__c}
              onChange={(value) =>
                this.props.changeForm({
                  edited_field: "Are_you_interested_for_Lucas_Service_Val__c",
                  edited_value: value,
                })
              }
...
export default connect(mapStateToProps, mapDispatchToProps)(WHRetailerOther);
