...
class WHRetailerInfo extends Component {
        ...
        >
          ...
          <View style={{ marginTop: hp("1.5%") }}>
            ...
            <View style={{ width: wp("90"), marginLeft: wp("2%") }}>
              <InputText
                style={Styles.inputtext}
                placeholder={"Enter Retailer Owner Name"}
          ...
          <Text style={{ color: "red", left: wp("2.5%") }}>
            {this.validatePhoneNumber(form.Whatsapp_Number__c) ? "" : "Invalid Phone No."}
          </Text>
          <View style={{ marginTop: hp("1.5%") }}>
          ...
          <Text style={{ color: "red", left: wp("2.5%") }}>
            {this.validateAadhaar(form.Aadhar_No__c) ? "" : "Invalid Aadhar No."}
          </Text>
          <View style={{ marginTop: hp("1.5%") }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(WHRetailerInfo);
