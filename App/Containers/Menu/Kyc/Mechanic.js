...
import MechanicOther from "./MechanicOther";
  ...
  onCheck() {
      ...
      records: [
        {
          ...
          Brand_No_1_Value__c: form.Brand_No_1_Value__c
            ...
            : "",
          Minor_Repair_in_No_s__c: form.Minor_Repair_in_No_s__c
            ? form.Minor_Repair_in_No_s__c
            : "",
          Year_of_Establishment__c: form.Year_of_Establishment__c,
    ...
    if (!form.Name) {
      HelperService.showToast({
        message: "Workshop Name Field is empty",
      });
    } else if (!form.Workshop_Owner_Name__c) {
      HelperService.showToast({
        message: "Workshop Owner Name Field is empty",
      });
    } else if (!form.Year_of_Establishment__c) {
      HelperService.showToast({
        message: "Year of Establishment Field is empty",
      });
    } else if (!form.Phone) {
      HelperService.showToast({
