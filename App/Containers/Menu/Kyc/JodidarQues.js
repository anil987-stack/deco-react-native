...
export class JodidarQues extends Component {
  render() {
                    ...
                    <TextInput
                      ...
                      value={
                        form.Value_AE_items1__c
                          ? String(form.Value_AE_items1__c)
                          : ""
                      }
                      onChangeText={(value) =>
                        changeForm({
                    ...
                    <TextInput
                      ...
                      value={
                        form.Value_AE_items2__c
                          ? String(form.Value_AE_items2__c)
                          : ""
                      }
                      onChangeText={(value) =>
                        changeForm({
                ...
                >
                  ...
                  <View style={{ justifyContent: "center" }}>
                    <TextInput
                      ...
                      placeholderTextColor="black"
                      value={
                        form.Value_Lube__c ? String(form.Value_Lube__c) : ""
                      }
                      onChangeText={(value) =>
                        changeForm({
                    ...
                    <TextInput
                      ...
                      value={
                        form.Value_2_3_Wheel_ranges__c
                          ? String(form.Value_2_3_Wheel_ranges__c)
                          : ""
                      }
                      onChangeText={(value) =>
                        changeForm({
...
export default connect(mapStateToProps, mapDispatchToProps)(JodidarQues);
