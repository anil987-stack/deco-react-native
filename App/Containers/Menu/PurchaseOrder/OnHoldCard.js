...
class OnHoldCard extends Component {
  componentDidMount() {
  ...
  filterResults(list) {
    ...
    let result = "";
    result = list.filter((obj) => obj.Order_Status__c == "Partially Delivered");
    // console.log(result)
...
export default connect(mapStateToProps, mapDispatchToProps)(OnHoldCard);
