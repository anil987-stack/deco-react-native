...
class CancelledCard extends Component {
    componentDidMount() {
  ...
  filterResults(list) {
    ...
    let result = "";
    result = list.filter((obj) => obj.Order_Status__c == "Created");
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledCard);
