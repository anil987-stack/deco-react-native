...
let extractData = {};
class AttachmentShow extends Component {
  componentDidMount() {
  ...
  render() {
    ...
    let visibleNode = (
      <ScrollView style={{...Style.action,left:wp("5.5%")}}>
        <FilePicker
    ...
    return (
      <View style={Style.container}>
        <Header style={{ justifyContent: "center",width:"100%" }} title={"ATTACHMENT"} />
...
export default connect(mapStateToProps, mapDispatchToProps)(AttachmentShow);
