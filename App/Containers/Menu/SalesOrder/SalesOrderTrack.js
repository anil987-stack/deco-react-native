...
class SalesOrderTrack extends Component {
  render() {
    ...
    return (
      <ScrollView style={{ marginBottom: hp("2%") }}>
        <View style={{ ...Styles.outerView, left: "1%" }}>
          ...
          <View style={Styles.textView}>
            <Text style={Styles.textStyle}>SAP Order No.</Text>
            <Text style={Styles.placeholder}>{"3250001"}</Text>
          </View>

          <View style={{ ...Styles.textView, left: wp("10%") }}>
            <Text style={Styles.textStyle}>SFDC Order Id</Text>
            <Text style={Styles.placeholder}>{"OD-0024"}</Text>
          </View>
          <View style={Styles.textView}>
...
export default connect(mapStateToProps, mapDispatchToProps)(SalesOrderTrack);
