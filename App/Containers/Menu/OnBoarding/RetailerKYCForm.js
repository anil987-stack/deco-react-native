...
import Styles from "./Tabscreens/Style";
import UserActions from "App/Stores/User/Actions";
import menuActions from "App/Stores/Menu/Actions";
import InputText from "App/Components/FormInput/InputText";
import InputNumber from "App/Components/FormInput/InputNumber";
import SearchableDropdown from "App/Components/SearchableDropdown";
import SelectDate from "App/Components/SelectDate/SelectYear";
...
class RetailerKYCForm extends Component {
  // componentDidMount() {
  ...
  render() {
    ...
    return (
      <ScrollView>
        <View style={{ flex: 1, marginTop: wp("0"), marginBottom: wp("30") }}>
        <Headerbar
            title={"Retailer Form"
            //   defaultSource
            //     ? `${
          ...
          />
           ...
           <View style={{ width: "80%",left:"5%",marginTop:"3%" }}>
          <Text
            style={{
              fontSize: 16,
            //   fontWeight: "bold",
        ...
        <View style={{ marginTop: hp("1.5%") }}>
            <Text style={Styles.text1}>Geo Location</Text>
            </View>
          ...
          <View style={{ marginTop: hp("1.5%") }}>
            <Text style={Styles.text1}>Govt. Identity</Text>
            </View>
          ...
          <View style={{ marginTop: hp("1.5%"), width: wp("90%"), }}>
            <Text style={Styles.text}>Tagged Distributor</Text>
            <SearchableDropdown
              // dataSource={options1}
              placeHolderText={"Select Tagged Distributor"}
            ...
            //   }
              ...
              invalid={false}
              customPickerStyles={{ ...Styles.picker,left:"28%" }}
          ...
          <View style={{ marginTop: hp("1.5%"), width: wp("90%"), }}>
            <Text style={Styles.text}>Retailer Type</Text>
            <SearchableDropdown
              // dataSource={options1}
              placeHolderText={"Select Retailer Type"}
              selectedValue={form.Secondary_No_Whatsapp}
              dropstyle={{left:"3%",
                width: wp("3"),
                height: wp("3"),
...
export default connect(mapStateToProps, mapDispatchToProps)(RetailerKYCForm);
