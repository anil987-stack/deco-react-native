...
class LeadChangeDate extends React.Component {
  componentDidMount() {
  ...
  dateFilter() {
    ...
    visiblePickerNode = (
      <View style={{ marginTop: hp("1.5%"), height: hp("8%") }}>
        <DatePicker
    ...
    return (
      ...
      <View style={{ ...Style.box1 }}>
        ...
        <View style={{ ...Style.buttonBox, marginTop: hp("7%") }}>
          ...
          <View style={{ flexDirection: "column", alignSelf: "center" , width:wp("80%"), marginTop:wp("5%")}}>
            <Text
              style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(LeadChangeDate);
