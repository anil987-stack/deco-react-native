...
class Leads extends Component {
            ...
            onPressMenu={() => {
              this.props.openModalThree({
                content3: (
                  <MenuModal
                    onClose={() => {
                      this.props.closeModalThree();
                    }}
                  />
                ),
                heading3: "LEAD MENU",
                bodyFlexHeight3: 1,
                headingStyle3: hp("41.6%"),
              });
            }}
            onPressTaskHistory={() => {
              NavigationService.navigate("TaskHistoryScreen");
            }}
          />
        )}
      />
  ...
  render() {
    ...
    const cardData = [
      { name: "SHAHID ALI HASMULLAH KHANS" },
      // { name: "SHAHID ALI HASMULLAH KHANS2" },
      // { name: "SHAHID ALI HASMULLAH KHANS3" },
    ];
    ...
    return (
      <>
        ...
        >
          ...
          {/* <LeadHeader /> */}
          <ScrollView
            style={{ marginTop: hp("-70%"), marginBottom: hp("10.5%") }}
          >
            {this.getCardNode(cardData)}
            <GenericIcon
              name={"refresh"}
              show={true}
