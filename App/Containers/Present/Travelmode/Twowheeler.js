...
// import { CANCEL, SUBMIT, LEAVE, WEEK_OFF } from '../../../'
...
class TwowheelerScreen extends Component {
  async submit() {
    ...
    this.props.startUserDay({
      ...
      StartTime: HelperService.getHMS(),
...
export default connect(mapStateToProps, mapDispatchToProps)(TwowheelerScreen);
