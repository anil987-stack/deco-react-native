...
class CreateExistingLayout extends React.Component {
	componentDidMount() {
	...
	<Text style={{marginLeft:wp('8'),marginTop:20,color:Colors.white,fontWeight:'bold',fontSize:wp('5.8')}}>Create Existing Product</Text>
	</View>
				            </View >
	    )
	}
