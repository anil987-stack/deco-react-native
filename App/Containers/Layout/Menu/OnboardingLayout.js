...
{ this.state.mount ? (
       ...
       <View
        ...
        <View>
          ...
          onPress={() => NavigationService.navigate("RetailerKYCForm")}
        >
          <GenericIcon
            name={"add"}
            style={{
          ...
          {/* <View style={{padding: 5,marginBottom:"1%",marginTop:"0.5%"}}>
              <BlueButton
                ...
                onPress={() =>
                  NavigationService.navigate("RetailerKYCForm")
                }
...
export default connect(
  mapStateToProps,
  mapDispatchToProps)(OnboardingLayout)
...
const Styles = StyleSheet.create({
    head: {
        ...
        fontSize: hp('3.2'), fontWeight: 'bold', marginLeft: 50, color: '#FFFFFF'
    },
    t2: {
        fontSize: hp('3.2'), fontWeight: 'bold', marginLeft: 15, color: '#343434'
    }, tt: {
        flexDirection: 'row'
