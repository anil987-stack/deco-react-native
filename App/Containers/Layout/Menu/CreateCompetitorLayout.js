...
import { Container, Header, Title, Content, Button, Icon, Left, Body, Text, Input, Item, Right, Badge,Spinner} from 'native-base';
...
class CreateCompetitorLayout extends React.Component {
	componentDidMount() {
    ...
    render() {
		...
		<GenericIcon
	    	...
	    	style={{ color:Colors.white,fontSize: wp('8%'),marginLeft:hp('1'),marginTop:hp('2.2')}}
		/>

	</TouchableOpacity>
	<Text style={{marginLeft:wp('4'),marginTop:20,color:Colors.white,fontWeight:'bold',fontSize:wp('5.8')}}>Create New Competitor Info</Text>
	</View>
				            </View >
	    )
	}
