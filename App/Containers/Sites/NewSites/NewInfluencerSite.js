...
class NewInfluencerSite extends Component {
	componentDidMount() {
		...
		// if (defaultSource) {
		// 	changeSiteForm({ edited_field: 'source__c', edited_value: defaultSource })
		// }else {
		// 	changeSiteForm({ edited_field: 'source__c', edited_value: '' })
		// }
	}
			...
			<View style={Style.container}>
				...
				<ScrollView style={Style.action}>
					...
					<SearchableDropdown
						...
						selectedValue={defaultSource || siteForm.source__c}
