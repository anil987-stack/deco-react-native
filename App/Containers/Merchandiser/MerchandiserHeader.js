...
class MerchandiserHeader extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={{ width: wp("100%"), justifyContent: "center" }}>
        ...
        <ScrollView
          ...
          horizontal={true}
          style={{ margin: "0%", flexDirection: "row", marginTop: hp("2.8%") }}
          ref={(ref) => {
          ...
          >
            <TouchableOpacity
              style={{
                ...
                margin: wp("1%"),
                borderTopColor:
                  this.state.selectedButton === "approval"
                    ? "white"
                    : "#b06060",
                borderTopWidth: 1.8,
              }}
...
export default connect(mapStateToProps, mapDispatchToProps)(MerchandiserHeader);
