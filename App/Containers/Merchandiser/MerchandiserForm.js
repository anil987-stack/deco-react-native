...
class MerchandiserForm extends Component {
  render() {
            ...
            <View>
              ...
              >
                <SearchableDropdown
                  ...
                  placeholder={"Type or Select Project Type"}
                  invalid={false}
                  customPickerStyles={{ ...Styles.picker, width: wp("50%") }}
                  labelStyles={{ ...Styles.pickerLabel }}
                  //invalid={validation.invalid && validation.invalid_field == 'area__c'}
                />
              </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(MerchandiserForm);
