...
import MerchandiserHeader from "./MerchandiserHeader";
import DraftCard from "./Draft";
import PendingCard from "./Pending";
import ApprovedCard from "./Approved";
...
class Merchandiser extends Component {
  componentDidMount() {
...
export default connect(mapStateToProps, mapDispatchToProps)(Merchandiser);
